    ...
    return new Vuex.Store({
        ...
        actions: {
            ...
            nuxtServerInit(vuexContext, context) {
                return axios.get("https://blogcontent-2ff2c.firebaseio.com/posts.json")
                    .then(res => {
                        const data = [];
            ...
            addPost(vuexContext, post) {
                ...
                return axios.
                    post("https://blogcontent-2ff2c.firebaseio.com/posts.json", createPost)
                    .then(res => {
            ...
            editPost(vuexContext, post) {
                return axios.
                    put("https://blogcontent-2ff2c.firebaseio.com/posts/" + post.id + ".json", post)
                    .then(res => {
                        // commit mutation
